...
problem. Empirical validation on GPT-2 is outlined but not yet conducted.
\end{abstract}
...
\begin{itemize}
  ...
  \item \textbf{No empirical results.} The GPT-2 protocol in
        Section~\ref{sec:protocol} has not been executed.
\end{itemize}
...
conjectures here into theorems. Empirical validation on GPT-2 is the next
step and has not yet been conducted.
